...
void draw_random_filled_cirlces(ALLEGRO_COLOR color, const int SCREEN_W, const int SCREEN_H);
...
void draw_random_triangles(ALLEGRO_COLOR color, const int width, const int height) {
